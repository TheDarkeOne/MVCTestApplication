...
namespace MVCTestApplication.Controllers
{
    public class ClassroomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClassName,TeacherName")] Classroom classroom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClassName,TeacherName")] Classroom classroom)
        {
            if (id != classroom.Id)
            {
                return NotFound();
